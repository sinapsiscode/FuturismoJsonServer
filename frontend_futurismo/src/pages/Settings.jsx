...
import ServicesConfigSettings from '../components/settings/ServicesConfigSettings';
...
const Settings = () => {
  ...
  const tabs = [
    ...
    },
    {
      ...
      name: 'Servicios',
      icon: CogIcon,
      description: 'Tipos de servicio, métodos de pago y configuraciones relacionadas'
    },
    {
      id: 'agencies',
      name: 'Agencias',
